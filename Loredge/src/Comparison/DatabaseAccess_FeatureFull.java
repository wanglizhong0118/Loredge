 ...
 * @author allwi
 */
public class DatabaseAccess_FeatureFull {
    ...
    public static void singleDatabaseSearch(String input, String database, String tempTxt) throws IOException {
        ...
        int tempTopWord = tempWordTrie.getTopWords();
        int tempMinAppr = tempWordTrie.getMinApprs();
    ...
    public static void singlePdfSearch(String pdf_publish, String pdf_authory, String temp_publish, String temp_authory) throws IOException {
        ...
        int topWord_publish = tree_publish.getTopWords();
        int minAppr_publish = tree_publish.getMinApprs();
        Map topList_publish = tree_publish.topWordsMap(topWord_publish);

        int topWord_authory = tree_authory.getTopWords();
        int minAppr_authory = tree_authory.getMinApprs();
