 ...
 * @author allwi
 */
public class DatabaseAccess_CompleteVer {
    ...
    public static void singleDatabaseSearch(String input, String database, String tempTxt) throws IOException {
        ...
        TreeMap tempCond = tempWordTrie.getTreeMap();
        ...
        long total = total_end - total_start;
        long read = read_end - read_start;
        long create = create_end - create_start;
        long compare = compare_end - compare_start;
        long result = result_end - result_start;

        System.out.println(key + " " + value + " " + total + " " + read + " " + create + " " + compare + " " + result);
    }
    ...
    public static void singlePdfSearch(String pdf_publish, String pdf_authory, String temp_publish, String temp_authory) throws IOException {
        ...
        TreeMap codition_publish = tree_publish.getTreeMap();
        TreeMap codition_authory_temp = tree_authory.getTreeMap();
    ...
    public static void pdfSearch(String pdf_publish_path, String pdf_authory_path,
        ...
        for (String fileName_publish : all_fileNames_publish) {
            ...
            TreeMap allwords_publish = tree_publish.getTreeMap();
            ...
            for (String fileName_authory : all_fileNames_authory) {
                ...
                TreeMap allwords_authory = SimilarityCalculation.extraVector(allwords_publish, tree_authory.getTreeMap());

                int[] vector_publish = SimilarityCalculation.createVector(allwords_publish);
                int[] vector_authory = SimilarityCalculation.createVector(allwords_authory);
