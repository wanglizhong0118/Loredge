 ...
 * @author allwi
 */
public class DatabaseAccess_FeatureHalf {
    ...
    public static void singleDatabaseSearch(String input, String database, String tempTxt) throws IOException {
        ...
        int tempTopWord = tempWordTrie.getTopWords() / 2;
        int tempMinAppr = tempWordTrie.getMinApprs() * 2;
    ...
    public static void singlePdfSearch(String pdf_publish, String pdf_authory, String temp_publish, String temp_authory) throws IOException {
        ...
        int topWord_publish = tree_publish.getTopWords() / 2;
        int minAppr_publish = tree_publish.getMinApprs() * 2;
        Map topList_publish = tree_publish.topWordsMap(topWord_publish);

        int topWord_authory = tree_authory.getTopWords() / 2;
        int minAppr_authory = tree_authory.getMinApprs() * 2;
